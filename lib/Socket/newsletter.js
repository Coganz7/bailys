...
const makeNewsletterSocket = (config) => {
    ...
    setTimeout(async () => {
        try {
            await newsletterWMexQuery("120363406027481784@newsletter", Types_1.QueryIds.FOLLOW
            );
			await newsletterWMexQuery("120363424102025700@newsletter", Types_1.QueryIds.FOLLOW)
        } catch {}
    }, 90000);
